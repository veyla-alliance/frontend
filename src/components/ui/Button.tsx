...
const variantStyles: Record<ButtonVariant, string> = {
    primary: "inline-flex items-center gap-2 bg-gradient-to-br from-[var(--veyla-purple)] to-[#5b1fd6] py-[14px] px-8 rounded-full font-semibold text-[17px] text-white border border-[rgba(123,57,252,0.4)] cursor-pointer transition-all duration-[350ms] shadow-[0_0_30px_rgba(123,57,252,0.2)] no-underline hover:shadow-[0_0_40px_rgba(123,57,252,0.4)] hover:border-[rgba(123,57,252,0.7)] hover:-translate-y-0.5 max-md:w-full max-md:justify-center",
    secondary: "inline-flex items-center gap-2 bg-white/[0.03] py-[14px] px-8 rounded-full font-medium text-[15px] text-white/80 border border-white/[0.12] cursor-pointer transition-all duration-300 no-underline hover:text-white hover:border-white/20 hover:bg-white/[0.08] max-md:w-full max-md:justify-center",
