        ...
        <>
            <div className="flex-1 flex flex-col items-center justify-center gap-6 py-24">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-gradient-to-r from-[var(--veyla-purple)] to-[#5b1fd6] text-white text-[14px] font-semibold transition-all duration-200 hover:shadow-[0_0_20px_rgba(123,57,252,0.3)] hover:-translate-y-px"
                >
                    Connect Wallet
                </button>
