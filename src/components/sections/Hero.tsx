    ...
    return (
        ...
        >
            ...
            <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_50%_60%,#1a0840_0%,#0a0520_40%,var(--veyla-dark)_100%)]">
                ...
                <video autoPlay loop muted playsInline preload="none" className="w-full h-full object-cover object-center hidden md:block">
                    <source src="/hero-video.webm" type="video/webm" />
                    <source src="/hero-video.mp4" type="video/mp4" />
                </video>
                {/* Mobile: lightweight 720p webm */}
                <video autoPlay loop muted playsInline preload="none" className="w-full h-full object-cover object-center md:hidden">
